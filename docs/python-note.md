...
- [启动命令](#启动命令)
- [](#)
- [flask\_app 来自flask\_app.py](#flask_app-来自flask_apppy)
- [app 来自 app = Flask(__name__)](#app-来自-app--flaskname)
- [-c 指定 配置文件](#-c-指定-配置文件)
- [不使用配置文件](#不使用配置文件)
- [找到 父进程的 pid (masterpid)](#找到-父进程的-pid-masterpid)
- [或者 找到所有进程 pid, 然后 kill -9 所有相关进程](#或者-找到所有进程-pid-然后-kill--9-所有相关进程)
...
rye toolchain list [--list-downloadable]
```
...
- [1. 介绍](#1-%E4%BB%8B%E7%BB%8D)
    - [1.1. python 特点](#11-python-%E7%89%B9%E7%82%B9)
    - [1.2. python 安装](#12-python-%E5%AE%89%E8%A3%85)
    - [1.3. python升级](#13-python%E5%8D%87%E7%BA%A7)
    - [1.4. vscode 环境配置](#14-vscode-%E7%8E%AF%E5%A2%83%E9%85%8D%E7%BD%AE)
    - [1.5. 设置国内pip源](#15-%E8%AE%BE%E7%BD%AE%E5%9B%BD%E5%86%85pip%E6%BA%90)
    - [1.6. 解释器](#16-%E8%A7%A3%E9%87%8A%E5%99%A8)
    - [1.7. kite 插件使用](#17-kite-%E6%8F%92%E4%BB%B6%E4%BD%BF%E7%94%A8)
- [2. 语法](#2-%E8%AF%AD%E6%B3%95)
    - [2.1. 输入输出 打印 main魔法变量](#21-%E8%BE%93%E5%85%A5%E8%BE%93%E5%87%BA-%E6%89%93%E5%8D%B0-main%E9%AD%94%E6%B3%95%E5%8F%98%E9%87%8F)
    - [2.2. 基本数据类型](#22-%E5%9F%BA%E6%9C%AC%E6%95%B0%E6%8D%AE%E7%B1%BB%E5%9E%8B)
        - [2.2.1. 字符串](#221-%E5%AD%97%E7%AC%A6%E4%B8%B2)
            - [2.2.1.1. 多行 不可变 比较](#2211-%E5%A4%9A%E8%A1%8C-%E4%B8%8D%E5%8F%AF%E5%8F%98-%E6%AF%94%E8%BE%83)
            - [2.2.1.2. 编码 字符处理](#2212-%E7%BC%96%E7%A0%81-%E5%AD%97%E7%AC%A6%E5%A4%84%E7%90%86)
            - [2.2.1.3. 格式化](#2213-%E6%A0%BC%E5%BC%8F%E5%8C%96)
            - [2.2.1.4. 字符串方法](#2214-%E5%AD%97%E7%AC%A6%E4%B8%B2%E6%96%B9%E6%B3%95)
        - [2.2.2. 字节 bytes](#222-%E5%AD%97%E8%8A%82-bytes)
        - [2.2.3. 数字](#223-%E6%95%B0%E5%AD%97)
        - [2.2.4. 布尔值 空值](#224-%E5%B8%83%E5%B0%94%E5%80%BC-%E7%A9%BA%E5%80%BC)
        - [2.2.5. 集合](#225-%E9%9B%86%E5%90%88)
            - [2.2.5.1. 有序可变 list](#2251-%E6%9C%89%E5%BA%8F%E5%8F%AF%E5%8F%98-list)
            - [2.2.5.2. 切片 slices](#2252-%E5%88%87%E7%89%87-slices)
            - [2.2.5.3. 有序不可变列表 tuple](#2253-%E6%9C%89%E5%BA%8F%E4%B8%8D%E5%8F%AF%E5%8F%98%E5%88%97%E8%A1%A8-tuple)
            - [2.2.5.4. 无序不可重复 set](#2254-%E6%97%A0%E5%BA%8F%E4%B8%8D%E5%8F%AF%E9%87%8D%E5%A4%8D-set)
        - [2.2.6. 键值存储 字典 dict](#226-%E9%94%AE%E5%80%BC%E5%AD%98%E5%82%A8-%E5%AD%97%E5%85%B8-dict)
        - [2.2.7. 列表推导式](#227-%E5%88%97%E8%A1%A8%E6%8E%A8%E5%AF%BC%E5%BC%8F)
        - [2.2.8. 生成器 generator](#228-%E7%94%9F%E6%88%90%E5%99%A8-generator)
        - [2.2.9. 迭代器](#229-%E8%BF%AD%E4%BB%A3%E5%99%A8)
    - [2.3. 条件循环](#23-%E6%9D%A1%E4%BB%B6%E5%BE%AA%E7%8E%AF)
    - [2.4. 比较判断](#24-%E6%AF%94%E8%BE%83%E5%88%A4%E6%96%AD)
    - [2.5. 函数](#25-%E5%87%BD%E6%95%B0)
        - [2.5.1. 参数检查](#251-%E5%8F%82%E6%95%B0%E6%A3%80%E6%9F%A5)
        - [2.5.2. 多种参数](#252-%E5%A4%9A%E7%A7%8D%E5%8F%82%E6%95%B0)
        - [2.5.3. 递归](#253-%E9%80%92%E5%BD%92)
        - [2.5.4. 高阶函数](#254-%E9%AB%98%E9%98%B6%E5%87%BD%E6%95%B0)
    - [2.6. 文件处理](#26-%E6%96%87%E4%BB%B6%E5%A4%84%E7%90%86)
        - [2.6.1. 创建文件](#261-%E5%88%9B%E5%BB%BA%E6%96%87%E4%BB%B6)
        - [2.6.2. 读写文件数据](#262-%E8%AF%BB%E5%86%99%E6%96%87%E4%BB%B6%E6%95%B0%E6%8D%AE)
    - [2.7. 装饰器](#27-%E8%A3%85%E9%A5%B0%E5%99%A8)
    - [2.8. 模块 作用域](#28-%E6%A8%A1%E5%9D%97-%E4%BD%9C%E7%94%A8%E5%9F%9F)
    - [2.9. 面向对象](#29-%E9%9D%A2%E5%90%91%E5%AF%B9%E8%B1%A1)
        - [2.9.1. 类](#291-%E7%B1%BB)
        - [2.9.2. 继承 鸭子类型](#292-%E7%BB%A7%E6%89%BF-%E9%B8%AD%E5%AD%90%E7%B1%BB%E5%9E%8B)
        - [2.9.3. 判断类型信息](#293-%E5%88%A4%E6%96%AD%E7%B1%BB%E5%9E%8B%E4%BF%A1%E6%81%AF)
        - [2.9.4. 动态操作](#294-%E5%8A%A8%E6%80%81%E6%93%8D%E4%BD%9C)
        - [2.9.5. 魔术方法](#295-%E9%AD%94%E6%9C%AF%E6%96%B9%E6%B3%95)
        - [2.9.6. 枚举](#296-%E6%9E%9A%E4%B8%BE)
        - [2.9.7. 实例方法 类方法 静态方法](#297-%E5%AE%9E%E4%BE%8B%E6%96%B9%E6%B3%95-%E7%B1%BB%E6%96%B9%E6%B3%95-%E9%9D%99%E6%80%81%E6%96%B9%E6%B3%95)
    - [2.10. 错误异常处理](#210-%E9%94%99%E8%AF%AF%E5%BC%82%E5%B8%B8%E5%A4%84%E7%90%86)
- [3. 工程化](#3-%E5%B7%A5%E7%A8%8B%E5%8C%96)
    - [3.1. cookiecutter 项目模板](#31-cookiecutter-%E9%A1%B9%E7%9B%AE%E6%A8%A1%E6%9D%BF)
    - [3.2. Setuptools: 管理依赖、构建和发布](#32-setuptools-%E7%AE%A1%E7%90%86%E4%BE%9D%E8%B5%96%E6%9E%84%E5%BB%BA%E5%92%8C%E5%8F%91%E5%B8%83)
    - [3.3. 虚拟环境](#33-%E8%99%9A%E6%8B%9F%E7%8E%AF%E5%A2%83)
    - [3.4. devops 构建流水线](#34-devops-%E6%9E%84%E5%BB%BA%E6%B5%81%E6%B0%B4%E7%BA%BF)
    - [3.5. 发布自定义库](#35-%E5%8F%91%E5%B8%83%E8%87%AA%E5%AE%9A%E4%B9%89%E5%BA%93)
    - [3.6. 项目结构](#36-%E9%A1%B9%E7%9B%AE%E7%BB%93%E6%9E%84)
    - [3.7. 模块引入 import原理](#37-%E6%A8%A1%E5%9D%97%E5%BC%95%E5%85%A5-import%E5%8E%9F%E7%90%86)
    - [3.8. 类型检车 type hints](#38-%E7%B1%BB%E5%9E%8B%E6%A3%80%E8%BD%A6-type-hints)
    - [3.9. linter 工具](#39-linter-%E5%B7%A5%E5%85%B7)
    - [3.10. 依赖安全性检查](#310-%E4%BE%9D%E8%B5%96%E5%AE%89%E5%85%A8%E6%80%A7%E6%A3%80%E6%9F%A5)
    - [3.11. 代码风格 格式化](#311-%E4%BB%A3%E7%A0%81%E9%A3%8E%E6%A0%BC-%E6%A0%BC%E5%BC%8F%E5%8C%96)
    - [3.12. 配置文件管理](#312-%E9%85%8D%E7%BD%AE%E6%96%87%E4%BB%B6%E7%AE%A1%E7%90%86)
    - [3.13. 测试test](#313-%E6%B5%8B%E8%AF%95test)
        - [3.13.1. 单元测试 unittest](#3131-%E5%8D%95%E5%85%83%E6%B5%8B%E8%AF%95-unittest)
        - [3.13.2. 集成测试 integration test](#3132-%E9%9B%86%E6%88%90%E6%B5%8B%E8%AF%95-integration-test)
    - [3.14. 包管理](#314-%E5%8C%85%E7%AE%A1%E7%90%86)
        - [3.14.1. rye 使用](#3141-rye-%E4%BD%BF%E7%94%A8)
    - [3.15. 日志](#315-%E6%97%A5%E5%BF%97)
    - [3.16. 生成文档](#316-%E7%94%9F%E6%88%90%E6%96%87%E6%A1%A3)
- [4. 多进程](#4-%E5%A4%9A%E8%BF%9B%E7%A8%8B)
- [5. 异步](#5-%E5%BC%82%E6%AD%A5)
- [6. 内建模块](#6-%E5%86%85%E5%BB%BA%E6%A8%A1%E5%9D%97)
    - [6.1. 日期处理](#61-%E6%97%A5%E6%9C%9F%E5%A4%84%E7%90%86)
    - [6.2. 集合](#62-%E9%9B%86%E5%90%88)
- [7. 编写命令行程序](#7-%E7%BC%96%E5%86%99%E5%91%BD%E4%BB%A4%E8%A1%8C%E7%A8%8B%E5%BA%8F)
    - [7.1. 命令行自动补全](#71-%E5%91%BD%E4%BB%A4%E8%A1%8C%E8%87%AA%E5%8A%A8%E8%A1%A5%E5%85%A8)
- [8. 类型系统 type-hint](#8-%E7%B1%BB%E5%9E%8B%E7%B3%BB%E7%BB%9F-type-hint)
- [9. 调试](#9-%E8%B0%83%E8%AF%95)
    - [9.1. 断言](#91-%E6%96%AD%E8%A8%80)
    - [9.2. 设置断点 pdb](#92-%E8%AE%BE%E7%BD%AE%E6%96%AD%E7%82%B9-pdb)
- [10. jinja2 模板](#10-jinja2-%E6%A8%A1%E6%9D%BF)
- [11. 路径问题](#11-%E8%B7%AF%E5%BE%84%E9%97%AE%E9%A2%98)
    - [11.1. 文件路径 and 终端路径](#111-%E6%96%87%E4%BB%B6%E8%B7%AF%E5%BE%84-and-%E7%BB%88%E7%AB%AF%E8%B7%AF%E5%BE%84)
    - [11.2. 获取脚本位置](#112-%E8%8E%B7%E5%8F%96%E8%84%9A%E6%9C%AC%E4%BD%8D%E7%BD%AE)
- [12. shutil 使用](#12-shutil-%E4%BD%BF%E7%94%A8)
- [13. venv 虚拟环境](#13-venv-%E8%99%9A%E6%8B%9F%E7%8E%AF%E5%A2%83)
- [14. web 开发](#14-web-%E5%BC%80%E5%8F%91)
    - [14.1. fastapi](#141-fastapi)
    - [14.2. Django](#142-django)
    - [14.3. flask](#143-flask)
        - [14.3.1. flask解决跨域问题](#1431-flask%E8%A7%A3%E5%86%B3%E8%B7%A8%E5%9F%9F%E9%97%AE%E9%A2%98)
        - [14.3.2. 保护 flask api](#1432-%E4%BF%9D%E6%8A%A4-flask-api)
        - [14.3.3. 命令行or idea 启动](#1433-%E5%91%BD%E4%BB%A4%E8%A1%8Cor-idea-%E5%90%AF%E5%8A%A8)
        - [14.3.4. rest api](#1434-rest-api)
        - [14.3.5. 数据库交互](#1435-%E6%95%B0%E6%8D%AE%E5%BA%93%E4%BA%A4%E4%BA%92)
        - [14.3.6. flask 中的日志](#1436-flask-%E4%B8%AD%E7%9A%84%E6%97%A5%E5%BF%97)
        - [14.3.7. blueprint蓝图 模块化开发](#1437-blueprint%E8%93%9D%E5%9B%BE-%E6%A8%A1%E5%9D%97%E5%8C%96%E5%BC%80%E5%8F%91)
        - [14.3.8. 上下文对象](#1438-%E4%B8%8A%E4%B8%8B%E6%96%87%E5%AF%B9%E8%B1%A1)
    - [14.4. fastapi](#144-fastapi)
- [15. db 驱动 问题](#15-db-%E9%A9%B1%E5%8A%A8-%E9%97%AE%E9%A2%98)
- [16. 代替 shell 运维](#16-%E4%BB%A3%E6%9B%BF-shell-%E8%BF%90%E7%BB%B4)
    - [16.1. 实用脚本](#161-%E5%AE%9E%E7%94%A8%E8%84%9A%E6%9C%AC)
        - [16.1.1. 命令行参数解析](#1611-%E5%91%BD%E4%BB%A4%E8%A1%8C%E5%8F%82%E6%95%B0%E8%A7%A3%E6%9E%90)
        - [16.1.2. 路径](#1612-%E8%B7%AF%E5%BE%84)
        - [16.1.3. 文件操作](#1613-%E6%96%87%E4%BB%B6%E6%93%8D%E4%BD%9C)
        - [16.1.4. sh 命令执行](#1614-sh-%E5%91%BD%E4%BB%A4%E6%89%A7%E8%A1%8C)
    - [16.2. 传递命令行参数](#162-%E4%BC%A0%E9%80%92%E5%91%BD%E4%BB%A4%E8%A1%8C%E5%8F%82%E6%95%B0)
    - [16.3. shell 调用 Python](#163-shell-%E8%B0%83%E7%94%A8-python)
        - [16.3.1. shel 读取 Python 函数返回值](#1631-shel-%E8%AF%BB%E5%8F%96-python-%E5%87%BD%E6%95%B0%E8%BF%94%E5%9B%9E%E5%80%BC)
        - [16.3.2. 统计出现次数](#1632-%E7%BB%9F%E8%AE%A1%E5%87%BA%E7%8E%B0%E6%AC%A1%E6%95%B0)
        - [16.3.3. 读取 csv 文件](#1633-%E8%AF%BB%E5%8F%96-csv-%E6%96%87%E4%BB%B6)
    - [16.4. Python 调用 shell](#164-python-%E8%B0%83%E7%94%A8-shell)
        - [16.4.1. subprocess](#1641-subprocess)
        - [16.4.2. os.system](#1642-ossystem)
        - [16.4.3. os.popen](#1643-ospopen)
        - [16.4.4. system](#1644-system)
        - [16.4.5. sh](#1645-sh)
        - [16.4.6. paramiko](#1646-paramiko)
    - [16.5. 部署 springboot](#165-%E9%83%A8%E7%BD%B2-springboot)
- [17. 开源库](#17-%E5%BC%80%E6%BA%90%E5%BA%93)
    - [17.1. 爬虫 crawler](#171-%E7%88%AC%E8%99%AB-crawler)
    - [17.2. 变声 语音合成](#172-%E5%8F%98%E5%A3%B0-%E8%AF%AD%E9%9F%B3%E5%90%88%E6%88%90)
    - [17.3. 系统运维](#173-%E7%B3%BB%E7%BB%9F%E8%BF%90%E7%BB%B4)
    - [17.4. 声音](#174-%E5%A3%B0%E9%9F%B3)
    - [17.5. 图像](#175-%E5%9B%BE%E5%83%8F)
    - [17.6. 数据模型定义](#176-%E6%95%B0%E6%8D%AE%E6%A8%A1%E5%9E%8B%E5%AE%9A%E4%B9%89)
    - [17.7. 序列化反序列化](#177-%E5%BA%8F%E5%88%97%E5%8C%96%E5%8F%8D%E5%BA%8F%E5%88%97%E5%8C%96)
    - [17.8. 做 web 开发](#178-%E5%81%9A-web-%E5%BC%80%E5%8F%91)
- [18. 调Java](#18-%E8%B0%83java)
    - [18.1. jpype](#181-jpype)
    - [18.2. jython](#182-jython)
- [19. 调用 rust](#19-%E8%B0%83%E7%94%A8-rust)
- [20. cffi 绑定](#20-cffi-%E7%BB%91%E5%AE%9A)
- [21. web应用部署](#21-web%E5%BA%94%E7%94%A8%E9%83%A8%E7%BD%B2)
    - [21.1. 生成依赖清单](#211-%E7%94%9F%E6%88%90%E4%BE%9D%E8%B5%96%E6%B8%85%E5%8D%95)
    - [21.2. gunicorn](#212-gunicorn)
