...
- [网约车](#网约车)
  ...
  - [支付流程](#支付流程)
  - [开放平台](#开放平台)
  - [数据一致性(分布式锁, 分布式事务)](#数据一致性分布式锁-分布式事务)
- [2. 短网址 短链接](#2-短网址-短链接)
- [3. 数据迁移 同步双写方案](#3-数据迁移-同步双写方案)
- [4. 第三方登录](#4-第三方登录)
- [5. 直播弹幕系统](#5-直播弹幕系统)
- [6. 秒杀系统](#6-秒杀系统)
  - [6.1. 秒杀解决方案](#61-秒杀解决方案)
- [7. 积分系统](#7-积分系统)
- [8. 电商账户系统](#8-电商账户系统)
- [9. 订单系统](#9-订单系统)
  - [9.1. 订单号生成策略](#91-订单号生成策略)
  - [9.2. 订单创建](#92-订单创建)
    - [9.2.1. 扣减库存](#921-扣减库存)
      - [9.2.1.1. 下单减库存](#9211-下单减库存)
      - [9.2.1.2. 付款减库存](#9212-付款减库存)
- [10. 支付系统](#10-支付系统)
  - [10.1. 入门介绍](#101-入门介绍)
  - [10.2. 单元化](#102-单元化)
- [11. feed 流系统](#11-feed-流系统)
- [12. 点赞模块设计](#12-点赞模块设计)
  - [12.1. 设计思路](#121-设计思路)
  - [12.2. 优缺点](#122-优缺点)
  - [12.3. 数据结构设计](#123-数据结构设计)
- [13. 扫码登录](#13-扫码登录)
  - [13.1. 扫码设计思路](#131-扫码设计思路)
- [14. Excel 表导入优化](#14-excel-表导入优化)
- [15. java 监控系统设计](#15-java-监控系统设计)
  - [15.1. 检测哪些内容](#151-检测哪些内容)
  - [15.2. 如何监控](#152-如何监控)
    - [15.2.1. 程序内置监测](#1521-程序内置监测)
    - [15.2.2. jdk 自带可视化工具](#1522-jdk-自带可视化工具)
    - [15.2.3. jdk 自带命令行工具](#1523-jdk-自带命令行工具)
    - [15.2.4. 第三方工具](#1524-第三方工具)
  - [15.3. 案例 生鲜电商监控平台](#153-案例-生鲜电商监控平台)
- [16. 消息推送系统 IM 系统](#16-消息推送系统-im-系统)
- [17. 流程引擎系统](#17-流程引擎系统)
- [18. 权限系统](#18-权限系统)
- [19. 日志采集系统](#19-日志采集系统)
...
- [22. 撮合系统](#22-撮合系统)
  ...
  - [22.2. Hazelcast](#222-hazelcast)
  - [22.3. disruptor](#223-disruptor)
