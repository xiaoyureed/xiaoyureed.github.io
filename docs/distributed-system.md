...
- [5. BASE 理论](#5-base-理论)
- [6. 分布式事务](#6-分布式事务)
  - [6.1. 事务概念and选型](#61-事务概念and选型)
  - [6.2. sharding jdbc](#62-sharding-jdbc)
    - [6.2.1. 对比 概念](#621-对比-概念)
    - [6.2.2. 使用 shardingjdbc](#622-使用-shardingjdbc)
  - [6.3. 基于 xa 协议的](#63-基于-xa-协议的)
    - [6.3.1. PC](#631-pc)
    - [6.3.2. PC](#632-pc)
  - [6.4. TCC 失败补偿模式](#64-tcc-失败补偿模式)
  - [6.5. 基于异步消息](#65-基于异步消息)
    - [6.5.1. 只使用消息中间件](#651-只使用消息中间件)
    - [6.5.2. 本地消息表 + mq](#652-本地消息表--mq)
- [7. 分布式锁](#7-分布式锁)
...
- [13. 分布式 session 一致性问题](#13-分布式-session-一致性问题)
  - [13.1. 为什么需要 sso](#131-为什么需要-sso)
    - [13.1.1. 单系统中的登陆是怎样的](#1311-单系统中的登陆是怎样的)
    - [13.1.2. 多系统中的登陆](#1312-多系统中的登陆)
  - [13.2. 解决方案](#132-解决方案)
    - [13.2.1. session 复制同步](#1321-session-复制同步)
    - [13.2.2. 客户端存储 session](#1322-客户端存储-session)
    - [13.2.3. NGINX 中对 ip 进行hash 路由](#1323-nginx-中对-ip-进行hash-路由)
    - [13.2.4. 后端集中 session](#1324-后端集中-session)
