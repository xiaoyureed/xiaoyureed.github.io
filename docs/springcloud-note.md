...
- [12. 消息总线](#12-消息总线)
  ...
  - [12.2. alibaba nacos 作为消息总线](#122-alibaba-nacos-作为消息总线)
- [13. spring-cloud-stream 消息驱动](#13-spring-cloud-stream-消息驱动)
- [14. spring-cloud-data-flow](#14-spring-cloud-data-flow)
- [15. 分布式事务 seata](#15-分布式事务-seata)
- [16. spring cloud alibaba 配合 dubbo](#16-spring-cloud-alibaba-配合-dubbo)
- [17. 实际设计案例 票务网站](#17-实际设计案例-票务网站)
  - [17.1. 业务架构](#171-业务架构)
  - [17.2. 应用架构](#172-应用架构)
  - [17.3. 技术架构](#173-技术架构)
  - [17.4. 数据库架构](#174-数据库架构)
  - [17.5. 项目管理](#175-项目管理)
- [18. 案例 在线教育](#18-案例-在线教育)
  - [18.1. 行业背景 and 商业模式](#181-行业背景-and-商业模式)
- [19. 案例 聚合支付](#19-案例-聚合支付)
  - [19.1. 聚合支付概念](#191-聚合支付概念)
  - [19.2. 集合支付项目架构](#192-集合支付项目架构)
  - [19.3. 支付业务流程](#193-支付业务流程)
- [20. 案例 广告系统](#20-案例-广告系统)
  - [20.1. 广告概念](#201-广告概念)
  - [20.2. 系统组成](#202-系统组成)
  - [20.3. 广告的核心业务流程](#203-广告的核心业务流程)
  - [20.4. 技术难点](#204-技术难点)
    - [20.4.1. 广告数据的存储](#2041-广告数据的存储)
    - [20.4.2. 广告数据检索](#2042-广告数据检索)
    - [20.4.3. 计费平台的技术方案](#2043-计费平台的技术方案)
  - [20.5. 广告表设计](#205-广告表设计)
  - [20.6. MySQL 的 binlog 实现增量索引](#206-mysql-的-binlog-实现增量索引)
    - [20.6.1. java 组件实现监控](#2061-java-组件实现监控)
    - [20.6.2. binlog 配置 SQL](#2062-binlog-配置-sql)
- [21. 案例 电商类网站](#21-案例-电商类网站)
  - [21.1. 开发环境搭建](#211-开发环境搭建)
  - [21.2. 行业术语](#212-行业术语)
  - [21.3. 业务流程分析](#213-业务流程分析)
    - [21.3.1. 商品新增](#2131-商品新增)
    - [21.3.2. 商品上架](#2132-商品上架)
  - [21.4. elasticsearch 数据建模分析](#214-elasticsearch-数据建模分析)
  - [21.5. 缓存分析](#215-缓存分析)
  - [21.6. 部署架构分析](#216-部署架构分析)
  - [21.7. 异步处理分析](#217-异步处理分析)
    - [21.7.1. mq](#2171-mq)
- [22. 案例 物联网平台](#22-案例-物联网平台)
...
## 12.2. alibaba nacos 作为消息总线

# 13. spring-cloud-stream 消息驱动
...
# 16. spring cloud alibaba 配合 dubbo
