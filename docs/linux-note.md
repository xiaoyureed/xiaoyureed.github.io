...
- [2. ebpf](#2-ebpf)
- [3. 介绍](#3-介绍)
- [4. 主机规划-磁盘分区](#4-主机规划-磁盘分区)
    - [4.1. 系统开机过程](#41-系统开机过程)
    - [4.2. 硬件设备在Linux中的文件名称](#42-硬件设备在linux中的文件名称)
    - [4.3. 磁盘组成](#43-磁盘组成)
    - [4.4. 磁盘分割](#44-磁盘分割)
    - [4.5. 挂载(mount):文件系统(磁盘)和目录树结合](#45-挂载mount文件系统磁盘和目录树结合)
- [5. linux系统目录规范/Filesystem Hierarchy Standard (FHS)](#5-linux系统目录规范filesystem-hierarchy-standard-fhs)
    - [5.1. 详细目录用途说明](#51-详细目录用途说明)
    - [5.2. 不能和\[/\]分开到不同分区的目录](#52-不能和分开到不同分区的目录)
    - [5.3. FHS推荐的目录规范](#53-fhs推荐的目录规范)
        - [5.3.1. \[/\]的内容和意义](#531-的内容和意义)
        - [5.3.2. \[/usr\]的内容和意义](#532-usr的内容和意义)
        - [5.3.3. \[/var\]的内容和意义](#533-var的内容和意义)
- [6. 杂七杂八的问题](#6-杂七杂八的问题)
    - [入侵后排查 tips 应急响应指南](#入侵后排查-tips-应急响应指南)
    - [6.1. 命令帮助](#61-命令帮助)
        - [6.1.1. whatis](#611-whatis)
        - [6.1.2. info](#612-info)
        - [6.1.3. man](#613-man)
        - [6.1.4. which](#614-which)
    - [6.2. 环境变量](#62-环境变量)
    - [6.3. 日期时间日历计算器](#63-日期时间日历计算器)
- [7. 常见问题](#7-常见问题)
    - [7.1. 关机 重启](#71-关机-重启)
    - [7.2. root密码丢失了](#72-root密码丢失了)
    - [7.3. 文件系统错误的问题](#73-文件系统错误的问题)
- [8. nano使用](#8-nano使用)
- [9. vi和vim使用](#9-vi和vim使用)
    - [9.1. 快捷键](#91-快捷键)
    - [9.2. 常用指令示意图](#92-常用指令示意图)
    - [9.3. 几个常见的例子](#93-几个常见的例子)
    - [9.4. 暂存档和数据恢复](#94-暂存档和数据恢复)
    - [9.5. 区块选择](#95-区块选择)
    - [9.6. 多档案编辑和多窗口功能](#96-多档案编辑和多窗口功能)
    - [9.7. vim环境参数设定](#97-vim环境参数设定)
    - [9.8. dos和linux下的换行符](#98-dos和linux下的换行符)
- [10. 文件和目录的权限](#10-文件和目录的权限)
    - [10.1. 3个身份3种权限](#101-3个身份3种权限)
    - [10.2. 文件的属性,ls](#102-文件的属性ls)
    - [10.3. 改变文件属性\&权限](#103-改变文件属性权限)
        - [10.3.1. 改变群组chgrp](#1031-改变群组chgrp)
        - [10.3.2. 改变拥有者chown](#1032-改变拥有者chown)
        - [10.3.3. 改变权限chmod](#1033-改变权限chmod)
    - [10.4. 文件和目录的权限区别](#104-文件和目录的权限区别)
    - [10.5. 文件/目录的默认权限umask](#105-文件目录的默认权限umask)
    - [10.6. 文件/目录的隐藏属性chattr](#106-文件目录的隐藏属性chattr)
    - [10.7. 文件/目录的特殊权限SUID,SGID,SBIT](#107-文件目录的特殊权限suidsgidsbit)
        - [10.7.1. Set Uid](#1071-set-uid)
        - [10.7.2. Set Gid](#1072-set-gid)
        - [10.7.3. Sticky Bit](#1073-sticky-bit)
    - [10.8. 几个场景对应的权限分配](#108-几个场景对应的权限分配)
    - [10.9. 几个场景实例](#109-几个场景实例)
- [11. 文件和目录的管理](#11-文件和目录的管理)
    - [11.1. 路径问题](#111-路径问题)
    - [11.2. 处理目录的指令](#112-处理目录的指令)
    - [11.3. 文件查看/复制/删除/移动](#113-文件查看复制删除移动)
        - [11.3.1. 文件检视](#1131-文件检视)
        - [11.3.2. 文件复制/建立连接档(快捷方式)](#1132-文件复制建立连接档快捷方式)
        - [11.3.3. 删除文件/目录](#1133-删除文件目录)
        - [11.3.4. 移动or重命名](#1134-移动or重命名)
        - [11.3.5. 获取路径的文件名/目录名](#1135-获取路径的文件名目录名)
    - [11.4. 文件内容查看](#114-文件内容查看)
        - [11.4.1. cat和tac](#1141-cat和tac)
        - [11.4.2. nl设计行号](#1142-nl设计行号)
        - [11.4.3. 翻页检视more/less](#1143-翻页检视moreless)
        - [11.4.4. "行级别"的数据过滤head/tail](#1144-行级别的数据过滤headtail)
        - [11.4.5. 读取非文本数据od](#1145-读取非文本数据od)
    - [11.5. 创建文件/修改文件时间](#115-创建文件修改文件时间)
    - [11.6. 搜寻文件和指令](#116-搜寻文件和指令)
        - [11.6.1. which,whereis,locate](#1161-whichwhereislocate)
        - [11.6.2. find](#1162-find)
    - [11.7. 光盘写入工具和iso文件](#117-光盘写入工具和iso文件)
- [12. 硬盘和文件系统管理](#12-硬盘和文件系统管理)
    - [12.1. ext2文件系统](#121-ext2文件系统)
        - [12.1.1. inode,block,superblock](#1211-inodeblocksuperblock)
        - [12.1.2. fs格式化后的结构图](#1212-fs格式化后的结构图)
        - [12.1.3. 目录/文件和inode,block关系](#1213-目录文件和inodeblock关系)
    - [12.2. ext2/ext3文件存取和日志式文件系统](#122-ext2ext3文件存取和日志式文件系统)
    - [12.3. 磁盘/目录容量查看](#123-磁盘目录容量查看)
    - [12.4. 实体链接和符号链接](#124-实体链接和符号链接)
    - [12.5. 磁盘管理fdisk](#125-磁盘管理fdisk)
        - [12.5.1. 分区/删除](#1251-分区删除)
        - [12.5.2. 格式化mkfs](#1252-格式化mkfs)
        - [12.5.3. 检验fsch,badblocks](#1253-检验fschbadblocks)
        - [12.5.4. 挂载mount/unmount](#1254-挂载mountunmount)
        - [12.5.5. 设定开机挂载](#1255-设定开机挂载)
        - [12.5.6. 设定磁盘参数](#1256-设定磁盘参数)
    - [12.6. 内存置换空间(swap)](#126-内存置换空间swap)
- [13. 压缩和打包](#13-压缩和打包)
    - [13.1. 常见的压缩工具](#131-常见的压缩工具)
    - [13.2. gzip和zcat](#132-gzip和zcat)
    - [13.3. bzip2和bzcat](#133-bzip2和bzcat)
    - [13.4. 打包tar](#134-打包tar)
    - [13.5. dd](#135-dd)
    - [13.6. cpio](#136-cpio)
    - [13.7. dump完整备份工具](#137-dump完整备份工具)
    - [13.8. restore复原](#138-restore复原)
- [14. 帐号管理\&ACL权限设定](#14-帐号管理acl权限设定)
    - [14.1. user management](#141-user-management)
    - [14.2. ulimit限制用户的资源](#142-ulimit限制用户的资源)
- [15. 周期任务](#15-周期任务)
- [16. 磁盘阵列和LVM文件系统](#16-磁盘阵列和lvm文件系统)
- [17. 周期任务](#17-周期任务)
- [18. 程序管理](#18-程序管理)
    - [18.1. Job control背景前景](#181-job-control背景前景)
    - [18.2. 程序](#182-程序)
    - [18.3. 安装卸载](#183-安装卸载)
        - [18.3.1. 原始码-tarball](#1831-原始码-tarball)
            - [18.3.1.1. 一般的安装指令](#18311-一般的安装指令)
        - [18.3.2. 包管理软件-rpm和srmp和 yum](#1832-包管理软件-rpm和srmp和-yum)
            - [18.3.2.1. rpm](#18321-rpm)
                - [18.3.2.1.1. rpm安装软件](#183211-rpm安装软件)
                - [18.3.2.1.2. rpm更新软件](#183212-rpm更新软件)
                - [18.3.2.1.3. rpm查询软件](#183213-rpm查询软件)
                - [18.3.2.1.4. rpm验证和数字签名](#183214-rpm验证和数字签名)
                - [18.3.2.1.5. rpm软件卸载和重建数据库](#183215-rpm软件卸载和重建数据库)
            - [18.3.2.2. srpm](#18322-srpm)
        - [18.3.3. apt和apt-get](#1833-apt和apt-get)
        - [18.3.4. yum 使用](#1834-yum-使用)
- [19. SELinux](#19-selinux)
- [20. 防火墙](#20-防火墙)
    - [20.1. nftables (推荐, 代替 iptables)](#201-nftables-推荐-代替-iptables)
    - [20.2. iptables](#202-iptables)
- [21. 系统服务 daemons](#21-系统服务-daemons)
    - [21.1. daemons是什么](#211-daemons是什么)
    - [21.2. daemons相关的文件脚本](#212-daemons相关的文件脚本)
    - [21.3. 怎么启动](#213-怎么启动)
    - [21.4. 设定开机启动](#214-设定开机启动)
    - [21.5. service 和 systemctl 和 chkconfig 区别](#215-service-和-systemctl-和-chkconfig-区别)
    - [21.6. supervisor 进程管理](#216-supervisor-进程管理)
- [22. 操作记录](#22-操作记录)
    - [22.1. 安装c编译环境gcc](#221-安装c编译环境gcc)
    - [22.2. 安装nodejs](#222-安装nodejs)
    - [22.3. jdk环境](#223-jdk环境)
    - [22.4. maven环境](#224-maven环境)
    - [22.5. mysql环境](#225-mysql环境)
    - [22.6. 安装 zsh](#226-安装-zsh)
...
## 4.5. 挂载(mount):文件系统(磁盘)和目录树结合



# 5. linux系统目录规范/Filesystem Hierarchy Standard (FHS)
...
##### 18.3.2.1.4. rpm验证和数字签名

##### 18.3.2.1.5. rpm软件卸载和重建数据库
...
## 21.5. service 和 systemctl 和 chkconfig 区别
